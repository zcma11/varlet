...
`)])],-1);function y(k,N,V,C,$,B){const t=o("var-site-code-example");return c(),p("div",d,[i,u,s("div",_,[m,l(t,null,{default:a(()=>[j]),_:1}),l(t,null,{default:a(()=>[v]),_:1})]),s("div",f,[x,g,l(t,null,{default:a(()=>[b]),_:1}),l(t,null,{default:a(()=>[w]),_:1})])])}var W=n(h,[["render",y]]);export{W as default};
