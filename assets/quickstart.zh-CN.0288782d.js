...
`)])],-1);function w(b,x,V,A,N,C){const l=c("var-site-code-example");return p(),r("div",o,[i,d,j,s("div",m,[_,u,n(l,null,{default:t(()=>[v]),_:1})]),s("div",g,[f,n(l,null,{default:t(()=>[k]),_:1}),n(l,null,{default:t(()=>[y]),_:1})])])}var q=e(h,[["render",w]]);export{q as default};
