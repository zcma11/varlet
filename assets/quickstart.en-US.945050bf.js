...
`)])],-1),g={class:"card"},f=s("h3",null,"Webpack/Vite",-1),y=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," Install with npm or yarn or pnpm"),a(`
...
`)])],-1);function b(w,x,V,A,B,N){const l=c("var-site-code-example");return p(),r("div",h,[i,d,j,s("div",m,[u,_,n(l,null,{default:t(()=>[v]),_:1})]),s("div",g,[f,n(l,null,{default:t(()=>[y]),_:1}),n(l,null,{default:t(()=>[k]),_:1})])])}var I=e(o,[["render",b]]);export{I as default};
