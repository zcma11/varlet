...
`)])],-1);function f(v,y,b,w,x,T){const l=o("var-site-code-example");return c(),r("div",p,[d,i,s("div",u,[j,a(l,null,{default:t(()=>[_]),_:1}),a(l,null,{default:t(()=>[m]),_:1}),k,a(l,null,{default:t(()=>[g]),_:1})])])}var B=n(h,[["render",f]]);export{B as default};
