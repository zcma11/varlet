...
`)])],-1),v={class:"card"},_=s("h3",null,"Basic Usage",-1),b=s("p",null,[t("The refresh event will be Emitted when pull refresh, you should set "),s("code",null,"v-model"),t(" to "),s("code",null,"true"),t(" at the beginning of the event indicates that loading is under way, and setting "),s("code",null,"v-model"),t(" to "),s("code",null,"false"),t(" after completion indicates that loading is over.")],-1),g=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-pull-refresh"),t(),s("span",{class:"hljs-attr"},"v-model"),t("="),s("span",{class:"hljs-string"},'"isRefresh"'),t(" @"),s("span",{class:"hljs-attr"},"refresh"),t("="),s("span",{class:"hljs-string"},'"refresh"'),t(">")]),t(`
